...
public class AuthorizePermissionOrders : ActionFilterAttribute
{
    private readonly IUserService _userService;

    public AuthorizePermissionOrders(IUserService userService)
    {
    ...
    )
    {
        ...
        if (rolefilter != null)
        {
            ...
            {
                if (i.PermissionId == 6 && i.Canview == false)
                {
